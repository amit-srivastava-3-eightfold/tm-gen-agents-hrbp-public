                  ...
                  <tbody>
                    {(currentUser.id === 'csm' ? [
                      ...
                      ...((() => { try {
                        ...
                        return [{ name: 'AI for Customer Success', status, skills: ['AI-assisted commentary', 'Prompt Engineering'], moreSkills: 4, createdBy: 'Workforce Readiness', role: 'Customer Success Manager', assignDate: '4/10/2026', updatedOn: planDone ? '4/11/2026' : '4/10/2026', duration: 8, href: '/my-activity/dev-plan-templates/ai-powered-customer-success', aiGenerated: true }]
                      } catch { return [] } })()),
