          ...
          <TabsWithLines tabs={profileTabs} defaultValue={initialTab} className="col-span-12">
            ...
            <Tabs.Content value="development" className="tabs-with-lines__content">
              <div className="profile-section">
                ...
                {/* Plans table */}
                {(() => {
                  type PlanRow = { name: string; status: 'Completed' | 'In progress' | 'Not started'; createdBy: string; role: string; planTitle: string; assignDate: string; updatedOn: string; duration: number; aiGenerated?: boolean; planPct?: number; href?: string }
