...
const DEV_PLAN_COACH_SCRIPT: CoachTurn[] = [
  ...
  { speaker: 'ai', text: "Three plays — and there's a walkthrough in your learning library that shows the full flow end to end: [Pre-Call Prep with Claude for CSMs](video:precall-prep). Let me give you the gist now." },
]
  ...
  return (
    <div>
      ...
      {videoPosterOpen && (
        ...
        >
          <div onClick={(e) => e.stopPropagation()} style={{ position: 'relative', width: 'min(1020px, 95vw)', aspectRatio: '680 / 382', borderRadius: 12, overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.4)' }}>
            <button
              type="button"
              onClick={() => setVideoPosterOpen(false)}
              aria-label="Close"
