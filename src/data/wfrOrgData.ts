...
export const ORG = {
  ...
  hrsPerPersonWeek: 4,
  departments: [
    { name: 'Administrative', employees: 3385, aiPotential: 68, aiReadiness: 11 },
    { name: 'Finance', employees: 3385, aiPotential: 62, aiReadiness: 13 },
    { name: 'Marketing', employees: 3050, aiPotential: 50, aiReadiness: 23 },
    ...
    { name: 'Engineering', employees: 10500, aiPotential: 35, aiReadiness: 35 },
    ...
    { name: 'IT & Security', employees: 2325, aiPotential: 32, aiReadiness: 42 },
    { name: 'Data & Analytics', employees: 1975, aiPotential: 44, aiReadiness: 38 },
    { name: 'Partnerships', employees: 1225, aiPotential: 30, aiReadiness: 24 },
    { name: 'Procurement', employees: 975, aiPotential: 57, aiReadiness: 15 },
    { name: 'Facilities', employees: 775, aiPotential: 51, aiReadiness: 12 },
    { name: 'Communications', employees: 625, aiPotential: 43, aiReadiness: 27 },
    { name: 'Quality & Compliance', employees: 1820, aiPotential: 38, aiReadiness: 19 },
  ],
  roles: {
    Administrative: [
    ...
    Engineering: [
      { title: 'Software Engineer', employees: 2835, aiPotential: 44, aiReadiness: 38 },
      { title: 'Senior Software Engineer', employees: 2070, aiPotential: 39, aiReadiness: 42 },
      { title: 'Engineering Manager', employees: 150, aiPotential: 33, aiReadiness: 35 },
      { title: 'QA Automation Engineer', employees: 1090, aiPotential: 47, aiReadiness: 29 },
      { title: 'DevOps Engineer', employees: 980, aiPotential: 41, aiReadiness: 40 },
      { title: 'Frontend Engineer', employees: 1305, aiPotential: 43, aiReadiness: 36 },
      { title: 'Platform Engineer', employees: 870, aiPotential: 38, aiReadiness: 41 },
      { title: 'Mobile Developer', employees: 655, aiPotential: 42, aiReadiness: 34 },
      { title: 'Site Reliability Engineer', employees: 545, aiPotential: 36, aiReadiness: 43 },
    ],
    Legal: [
...
export const hrbpAssignments: { hrbp: string; dept: string; headcount: number }[] = [
  ...
  // Sales (6,200) → 3 HRBPs
  { hrbp: 'Dana Washington', dept: 'Sales', headcount: 2200 },
  { hrbp: 'Quinn Sullivan', dept: 'Sales', headcount: 2100 },
  { hrbp: 'Skyler Johansson', dept: 'Sales', headcount: 1900 },
  ...
  // Finance (3,385) → 2 HRBPs
  { hrbp: 'Emery Chang', dept: 'Finance', headcount: 1700 },
  { hrbp: 'Sage Petrov', dept: 'Finance', headcount: 1685 },
  // Marketing (3,050) → 2 HRBPs
  { hrbp: 'Avery Nakamura', dept: 'Marketing', headcount: 1550 },
  { hrbp: 'Drew Andersson', dept: 'Marketing', headcount: 1500 },
  // IT & Security (2,325) → 1 HRBP
  { hrbp: 'Riley Tanaka', dept: 'IT & Security', headcount: 2325 },
  // Product (2,075) → 1 HRBP
  { hrbp: 'Kendall Osei', dept: 'Product', headcount: 2075 },
  // Data & Analytics (1,975) → 1 HRBP
  { hrbp: 'Finley Larsson', dept: 'Data & Analytics', headcount: 1975 },
  // Quality & Compliance (1,820) → 1 HRBP
  { hrbp: 'Sarah Culhane', dept: 'Quality & Compliance', headcount: 1820 },
  // HR (1,600) → 1 HRBP
  { hrbp: 'Casey Nguyen', dept: 'HR', headcount: 1600 },
  // Legal (1,450) → 1 HRBP
  { hrbp: 'Reese Montoya', dept: 'Legal', headcount: 1450 },
  // Partnerships (1,225) → 1 HRBP
  { hrbp: 'Alex Rivera', dept: 'Partnerships', headcount: 1225 },
  // Procurement (975) → 1 HRBP
  { hrbp: 'Hayden Choi', dept: 'Procurement', headcount: 975 },
  // Facilities (775) → 1 HRBP
  { hrbp: 'Parker Adeyemi', dept: 'Facilities', headcount: 775 },
  // Communications (625) → 1 HRBP
  { hrbp: 'Devon Moreau', dept: 'Communications', headcount: 625 },
]

/** Get all HRBPs assigned to a department */
export function getDeptHrbps(deptName: string): { hrbp: string; headcount: number }[] {
  return hrbpAssignments.filter(a => a.dept === deptName)
}
