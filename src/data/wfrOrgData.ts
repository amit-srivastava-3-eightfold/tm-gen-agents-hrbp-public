...
export const ORG = {
  ...
  roles: {
    ...
    'Customer Success': [
      { title: 'Customer Success Manager', employees: 30, aiPotential: 45, aiReadiness: 23 },
      { title: 'Implementation Consultant', employees: 223, aiPotential: 48, aiReadiness: 20 },
      { title: 'Support Specialist', employees: 209, aiPotential: 37, aiReadiness: 17 },
      { title: 'Onboarding Manager', employees: 30, aiPotential: 42, aiReadiness: 22 },
      { title: 'Renewals Specialist', employees: 179, aiPotential: 50, aiReadiness: 19 },
      { title: 'Customer Insights Analyst', employees: 149, aiPotential: 55, aiReadiness: 28 },
    ],
    Product: [
