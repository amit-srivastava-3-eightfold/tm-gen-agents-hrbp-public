...
export const WFR_CTA_CONTENT: Record<WfrDemoState, Record<WfrPersona, WfrCtaBarContent>> = {
  ...
  '1b': {
    ...
    hrbp: {
      icon: 'flag',
      label: 'Your CHRO has kicked off data collection for your team.',
      hint: 'Launch data collection to sharpen adoption scores and surface upskilling priorities for your people.',
      buttonLabel: 'Launch data collection →',
      buttonVariant: 'primary',
      accent: RED,
    },
    manager: {
  ...
  2: {
    ...
    hrbp: {
      icon: 'sync',
      label: 'Your data collection is underway.',
      hint: '34 of 96 responded · 35% completion rate',
      buttonLabel: null,
      buttonVariant: 'secondary',
      accent: YELLOW,
      progress: 35,
  ...
  3: {
    ...
    hrbp: {
      ...
      hint: 'Each employee\'s responses are automatically generating their personalized development plan.',
    ...
    manager: {
      icon: 'check_circle',
      label: 'Collection complete — development plans are being generated for your team.',
      hint: 'Once plans are ready, you\'ll review and assign each one to your team members.',
      buttonLabel: 'What\'s next?',
      buttonVariant: 'secondary',
      accent: GREEN,
      progress: 100,
