...
const CSM_LEVEL_BASE: Omit<LevelDef, 'courses'>[] = [
  {
    ...
    xpLabel: 'QBR XP',
    outcome: 'Walk into every QBR with a defensible narrative drafted in minutes, not days — Claude pulls renewal numbers, usage trends, and ticket history from your sources and drafts commentary in your voice. You edit and tell the story; you don\'t stare at a blank slide.',
    tasks: [
      { text: 'Draft your next QBR using the prompt template against your usual data sources', description: 'Pick an upcoming QBR. Pull your usual Looker exports and account context, drop them into the prompt, and let Claude write a first-pass narrative. Edit for voice and accuracy — don\'t expect perfection from the first run.' },
      { text: 'Compare the AI draft to your last hand-written QBR — note what saved time and what needed rewriting', description: 'A simple side-by-side note is enough. Where did Claude nail the framing? Where did you have to rewrite? These observations sharpen the prompt for the next quarter.' },
    ],
    coachTask: {
...
const CSM_LEVEL_COURSES: Record<number, Course[]> = {
  1: [
    { name: 'AI-Assisted QBR Storytelling', provider: 'Eightfold Academy', duration: '2 hrs · self-paced', level: 'Beginner', free: true, description: 'Short video walkthrough plus a written guide of prompt templates for turning Looker exports, support tickets, and renewal context into a defensible QBR narrative — Claude drafts the commentary, you edit and tell the story.' },
  ],
  2: [
