...
function BoardView({
  ...
  const cards = [
    {
      ...
      l1: <span style={{ color: '#94a3b8' }}>Across {totalEmployeesHero.toLocaleString()} employees</span>,
  ...
  return (
    ...
    <WfrOverviewLayout
      ...
      subtitle={!hrbpPlansCreated ? <>Your org has <span className="font-bold wfr-text-potential">{formatHours(orgHrsUnlocked)}</span> in annual productivity hours waiting to be unlocked.</> : undefined}
  ...
  if (isManager && managerTeamData) {
    ...
    return (
      ...
      <WfrOverviewLayout
        ...
        subtitle={<>Your team has <span className="font-bold wfr-text-potential">{formatHours(displayMgrHrsUnlocked)}</span> in annual productivity hours to unlock.</>}
      ...
      <div className="min-w-0">
        ...
        {view === 'dept' && deptViewName && (() => {
          ...
          return (
            <PersonDetailLayout
              ...
              aiPotential={{ value: `${d.aiPotential}%`, explainer: `How much of this department's daily work AI is capable of supporting.`, description: <span style={{ color: '#94a3b8' }}>Across {d.employees.toLocaleString()} employees</span>, tag: <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 11, fontWeight: 600, color: '#15803d', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 10, padding: '2px 8px' }}><span style={{ width: 6, height: 6, borderRadius: '50%', background: '#22c55e' }} />Above industry median (38%)</span>, onLearnMore: () => setDashMetricInfoOpen(true) }}
              potential={{ value: formatHours(d.hrsUnlocked), description: <>Annual hours AI can unlock for people in the transformation gap.</>, onLearnMore: () => setDashMetricInfoOpen(true) }}
        ...
        {view === 'hrbp' && hrbpName && (() => {
          ...
          const hrbpOverviewCards: Parameters<typeof WfrOverviewLayout>[0]['cards'] = [
            ...
            { id: 'potential', icon: 'schedule', label: 'Productivity hours', value: formatHours(hrbpHrsUnlocked), description: <><span>Annual hours AI can unlock for people in the transformation gap.</span><span style={{ display: 'block', color: '#94a3b8', marginTop: 3 }}>Across {headcount.toLocaleString()} employees</span></>, onLearnMore: () => setDashMetricInfoOpen(true) },
          ]
          ...
          if (isHrbp) {
            return (
              ...
              <WfrOverviewLayout
                ...
                subtitle={!hrbpPlansComplete ? <>Your team has <span className="font-bold wfr-text-potential">{formatHours(hrbpHrsUnlocked)}</span> in annual productivity hours to unlock.</> : undefined}
          ...
          return (
            ...
            <PersonDetailLayout
              ...
              potential={{ value: formatHours(Math.round(d.hrsUnlocked * headcount / Math.max(1, d.employees))), description: 'Annual hours AI can unlock for people in the gap', onLearnMore: () => setDashMetricInfoOpen(true) }}
        ...
        {view === 'director' && directorData && (() => {
          ...
          return (
            <PersonDetailLayout
              ...
              aiPotential={{ value: `${d.aiPotential}%`, explainer: `How much of this team's daily work AI is capable of supporting.`, description: <span style={{ color: '#94a3b8' }}>Across {d.employees.toLocaleString()} employees</span>, tag: <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 11, fontWeight: 600, color: '#15803d', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 10, padding: '2px 8px' }}><span style={{ width: 6, height: 6, borderRadius: '50%', background: '#22c55e' }} />Above industry median (38%)</span>, onLearnMore: () => setDashMetricInfoOpen(true) }}
              potential={{ value: formatHours(Math.round(d.hrsUnlocked * dirHeadcount / Math.max(1, d.employees))), description: 'Annual hours AI can unlock for people in the gap', onLearnMore: () => setDashMetricInfoOpen(true) }}
        ...
        {view === 'seniorMgr' && seniorMgrData && (() => {
          ...
          return (
            <PersonDetailLayout
              ...
              aiPotential={{ value: `${d.aiPotential}%`, explainer: `How much of this team's daily work AI is capable of supporting.`, description: <span style={{ color: '#94a3b8' }}>Across {d.employees.toLocaleString()} employees</span>, tag: <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 11, fontWeight: 600, color: '#15803d', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 10, padding: '2px 8px' }}><span style={{ width: 6, height: 6, borderRadius: '50%', background: '#22c55e' }} />Above industry median (38%)</span>, onLearnMore: () => setDashMetricInfoOpen(true) }}
              potential={{ value: formatHours(scaleHrsUnlocked(Math.round(d.hrsUnlocked * srHeadcount / Math.max(1, d.employees)), srBaseReadiness, srMeasuredReadiness)), description: 'Annual hours AI can unlock for people in the gap', onLearnMore: () => setDashMetricInfoOpen(true) }}
        ...
        {view === 'role' && roleViewData && (() => {
          ...
          return (
            <PersonDetailLayout
              ...
              aiPotential={{ value: `${aiPotential}%`, explainer: "How much of this role's daily work AI can support.", description: <span style={{ color: '#94a3b8' }}>Across {totalEmployees.toLocaleString()} employees</span>, onLearnMore: () => setDashMetricInfoOpen(true) }}
              potential={{ value: formatHours(roleHrsUnlocked), description: 'Annual hours AI can unlock for people in the gap', onLearnMore: () => setDashMetricInfoOpen(true) }}
